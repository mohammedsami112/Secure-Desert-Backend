                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a target="_blank" rel="noopener noreferrer" href="{{ env('APP_URL') }}"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            You are receiving this email To Verify Your Email.</p>
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a target="_blank" rel="noopener noreferrer"
                                                                                href="{{ env('VERIFY_RETURN_URL') . '?verifyToken=' . $token }}"
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 14px;">
                                                        ...
                                                        <span class="break-all" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; word-break: break-all;"><a target="_blank" rel="noopener noreferrer" href="{{ env('VERIFY_RETURN_URL') . '?verifyToken=' . $token }}" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">{{ env('VERIFY_RETURN_URL') . '?verifyToken=' . $token }}</a></span>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
